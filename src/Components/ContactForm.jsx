...
// import {useMessage} from "../context_or_provider/MessageContext";
//
// const ContactForm = () => {
...
const ContactForm = () => {
  ...
  const { postMessage } = useMessage(); // 🟢 কাস্টম হুক থেকে postMessage ফাংশন নিচ্ছি
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await postMessage(formData); // 🟢 API-তে POST করছি
      alert("Thanks for reaching out!");
      setFormData({ name: '', email: '', subject: '', message: '' });
    } catch (error) {
